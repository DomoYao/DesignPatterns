...
namespace DotNet.Utilities
{
    ...
    public static class EnumExtension
    {
        ...
        public static bool TryParse<T>(this string name, out T value) where T : struct
        {
            ...
            return EnumDic<T>.TryGetValue(name, out value);
        }
            ...
            where T : struct
        {
            ...
            private static readonly Dictionary<ValueType, string>
                _dicByValue = new Dictionary<ValueType, string>();
            private static readonly Dictionary<string, T>
            ...
            public string this[ValueType stateCode]
            {
                get
                {
                    ...
                    {
                        throw new Exception("意外的枚举值:" + stateCode.ToString());
                    }
            ...
            private void Init()
            {
                ...
                var _values = Enum.GetValues(typeof(T)) as IEnumerable;
                int i = 0;
                foreach (var item in _values)
                {
                    _dicByValue.Add((ValueType)item, _names[i]);
                    _dicByString.Add(_names[i], (T)item);
                    i++;
                }
            }
            #endregion
